...
class Expenses(models.Model):
    ...
    Invoice_date=models.CharField(max_length=150,null=True)
    GstPer=models.IntegerField(null=True)
    CGSTPer=models.FloatField(null=True)
    SGSTPer=models.FloatField(null=True)
    PurchaseCompany=models.CharField(max_length=150,null=True)
